...
launcher = 'none'
load_from = '/home/luxiaodong/mmdetection/configs/dab_detr/dab-detr_r50_8xb2-50e_coco_20221122_120837-c1035c8c.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file='data/coco_TROUT/annotations/instances_val2017.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
