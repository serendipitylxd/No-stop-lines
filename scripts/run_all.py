...
- Step2: 3D inference (conda env "your-PCDet_trout-env" + inject PYTHONPATH=/path/to/PCDet_trout)
...
MMDET_ENV = "mmdet"
PCDET_ENV = "trout"
PCDET_REPO = "/home/luxiaodong/PCDet_trout"   # Step2 will be injected into PYTHONPATH


def run(cmd, env=None):
    """Execute a shell command with optional custom environment."""
    print(f"\n$ {cmd}")
